...
\usepackage[slide,linesnumbered,noend]{algorithm2e}
\Setnlsty{}{\scriptsize}{}
\SetKwComment{tnm}{\#}{}
...
\definecolor{acm114@sand}{HTML}{dddbc5} % use structure theme to change
\definecolor{acm114@olive}{HTML}{474a41} % use structure theme to change
\definecolor{acm114@lava}{HTML}{413b38} % use structure theme to change
