...
\usepackage{textcomp}
\usepackage{listings}
\definecolor{commentcolor}{gray}{.0}
\definecolor{stringcolor}{gray}{.1}
...
\lstnewenvironment{shell}[2][]{
  \lstset{
    ...
    basicstyle=\tt\tiny,
    keywordstyle=,
    commentstyle=\color{commentcolor}\slshape\bfseries,
...
\lstnewenvironment{python}[2][]{
  \lstset{
    ...
    keywordstyle=\color{acm114@olive}\bfseries,
...
% macros
\def\href#1{{\small\bfseries\url{#1}}}
...
\def\class#1{\mbox{\tt\small #1}}
\def\component#1{\mbox{\tt\small #1}}
\def\function#1{\mbox{\tt\small #1}}
\def\method#1{\mbox{\tt\small #1}}
\def\identifier#1{\mbox{\tt\small #1}}
\def\keyword#1{\mbox{\tt\small #1}}
\def\srcfile#1{\mbox{\tt\small #1}}
