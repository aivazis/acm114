...
%
\python{firstline=9,lastline=25, label={lst:python:pi}}{listings/pi.py}
%
...
%
  \python{firstline=9,lastline=24, label={lst:python:PointCloud}}{listings/PointCloud.py}
%
\end{frame}
...
%
  \python{firstline=9,lastline=29, label={lst:python:Mersenne}}{listings/Mersenne.py}
%
\end{frame}
...
%
  ...
  \end{itemize}
%
  \python{firstline=9,lastline=20, label={lst:python:Shape}}{listings/Shape.py}
%
\end{frame}
...
%
  \python{firstline=9,lastline=36, label={lst:python:Shape}}{listings/Disk.py}
%
\end{frame}
...
%
  \python{firstline=9,lastline=36, label={lst:python:classes}}{listings/classes.py}
%
\end{frame}
