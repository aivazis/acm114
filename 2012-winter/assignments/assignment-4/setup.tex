...
%
    ...
    linkcolor=acm114@olive, % color of internal links
    citecolor=acm114@olive, % color of links to bibliography
    filecolor=acm114@olive, % color of file links
    urlcolor=acm114@olive   % color of external links
}
% end of file 
