...
\definecolor{acm114@brick}{rgb}{0.95, .50, .30}
...
\def\CGM{\mbox{\sc ConjugateGradient}}
\def\backsub{\mbox{\sc BackwardSubstitution}}
\def\forwsub{\mbox{\sc ForwardSubstitution}}
\def\lu{\mbox{\sc LU}}
\def\cholesky{\mbox{\sc Cholesky}}
\def\treemake{\mbox{\sc tree.make}}
\def\rqscan{\mbox{\sc rq.scan}}
\def\rqbs{\mbox{\sc rq.bs}}
\def\rqtree{\mbox{\sc rq.tree}}
\def\rqcell{\mbox{\sc rq.cell}}
\def\bslb{\mbox{\sc binary-search-lower-bound}}
...
\hypersetup{
    pdftitle={ACM/CS 114: Winter 2012},
